      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tighter">
            L'élégance à la portée de tous avec <span className="text-primary italic">Isskha Collection</span>
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed">
            Née de la passion pour la mode et le raffinement, Isskha Collection est votre destination ultime pour les vêtements et accessoires de la plus haute qualité. Nous sélectionnons nos produits avec un soin extrême pour vous offrir une expérience d'achat incomparable.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-12 md:p-20 flex flex-col justify-center">
              ...
              <div className="space-y-4 text-lg text-muted-foreground">
                ...
                <p>
                  C'est ainsi qu'est née <strong>Isskha Collection</strong>. Plus qu'une simple boutique, c'est un style de vie. Notre mission est de vous aider à exprimer votre personnalité à travers des collections uniques et intemporelles.
                </p>
              </div>
              <div className="mt-8">
                <Link 
